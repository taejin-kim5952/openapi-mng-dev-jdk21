...
<script type="text/javascript">
  ...
  function proc_item(s_mode, rec) {
    ...
    $.ajax({
      type: 'POST',
      url: '<c:url value="/beast/api/bstAdmApiLinkData/ajax_proc.do"/>' + '?cmd=' + param['cmd'],
      data: JSON.stringify(param),
      contentType: 'application/json',
      dataType: 'JSON',
      async: false,
...
<script type="text/javascript">
  ...
  function fn_query_list(pageIndex, s_cmd) {
    ...
    $.ajax({
      url: '<c:url value="/beast/api/bstAdmApiLinkData/ajax_query.do"/>' + '?cmd=' + param['cmd'],
      type: 'POST',
      data :param,
...
<div id="container">
  <div class="sVisual sv_regiapi">
    <div>
      <h2>BEAST -  API Link Data 정보${dp_target_text}</h2>
  ...
  <div class="contents">
    <div class="conBox">
      ...
      <div id="content">
        ...
        <h5 class="rTitleOneDep">API Link Data 정보${dp_target_text} 관리</h5>

...
<c:set var="dp_prop_proc_seq" value="0" />
<c:set var="dp_prop_gw_profile" value="VERI" />
		...
		<div class="conBox">
			...
			<div class="dum-api_right">
				...
				<div id="content">
					...
					<!--// <vue-verify-execute prop_api_no="" prop_proc_seq="" prop_gw_profile="" prop_fn_emit=""></vue-verify-execute> //-->

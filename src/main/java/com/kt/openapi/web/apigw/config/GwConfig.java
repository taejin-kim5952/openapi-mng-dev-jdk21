...
import com.kt.openapi.web.apigw.utils.RestTemplateLoggingRequestInterceptor;
...
public class GwConfig {
    ...
    @Bean
    public RestTemplate gwRestTemplate() throws KeyStoreException, NoSuchAlgorithmException, KeyManagementException {
        ...
        final RequestConfig requestConfig = RequestConfig.custom()
                .setConnectTimeout(Timeout.ofMilliseconds(GwConstants.CONNECTION_TIMEOUT))
                .setResponseTimeout(Timeout.ofMilliseconds(GwConstants.READ_TIMEOUT))
                .build();

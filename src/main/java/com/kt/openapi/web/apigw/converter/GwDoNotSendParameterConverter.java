...
public class GwDoNotSendParameterConverter extends AbstractDataConverter<List<ApiParameter>, List<String>> {
    ...
    public List<String> convert(List<ApiParameter> source, List<String> target) throws ConversionException {
        for (ApiParameter parameter : source) {
            this.addHidden(prefix, parameter, target);
        }
        return target;
    }
